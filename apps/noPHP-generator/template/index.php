...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="app/event-player.css" />
    <?php 
...
<!-- EO  Data on the fly -->
    ...
    <script type="text/javascript" src="app/event-player.js"></script>
  </body>
</html>
...
function playPresentation(ID) {
    ...
    if (wasPaused != true) {
        ...
        if ((eventData.presentations[presentationID].slides[active].type == '.mov') || (eventData.presentations[presentationID].slides[active].type == '.mp4')) {
            ...
            //$('#activeSlide').append('<img id="slideshow" src="' + activeSlide + '" />');
...
function startSlideshow() {
    ...
    //alert('start slideshow: ' + active);
    if (smode === "play") {
        document.getElementById("play").disabled = "disabled";
        document.getElementById("pause").disabled = "";
        document.getElementById("stop").disabled = "";
        //document.getElementById("slideshow").src = imgsrc[active];
        //$('#slideshow').css('background-image', 'url('+imgsrc[active]+')');
...
function drawClock() {
    ...
    //console.log('updateSlide: ' + updateSlide);
    //console.log('activeDuration: ' + activeDuration);
}
